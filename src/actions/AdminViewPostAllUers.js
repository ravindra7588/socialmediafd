...
let adminViewPostAllUers = () => {
    ...
    return async function (dispatch) {
        const res = await axios.get(
            "http://localhost:8080/api/admin/post/allusers"
        );
        ...
        dispatch({ type: "VIEW_POST_ALL_USERID", payload: res.data });
    }
}

export default adminViewPostAllUers;